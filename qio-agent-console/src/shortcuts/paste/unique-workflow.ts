...
// generateUniqueWorkflow() [ID唯一化处理]
//     │
//     ├─ UniqueWorkflowUtils.getAllNodeIds()   // 收集所有节点ID
//     │   └─ addNodeId()                       // 递归添加节点ID
//     │       └─ node.blocks.forEach()         // 遍历子节点
//     │
//     ├─ UniqueWorkflowUtils.generateNodeReplaceMap() // 生成替换映射
//     │   ├─ isUniqueId()                      // 判断ID是否唯一
//     │   │   └─ entityManager.getEntityById() // 查找实体
//     │   └─ generateUniqueId()                // 生成新ID (nanoid)
//     │       └─ customAlphabet('1234567890', 6)
//     │
//     └─ UniqueWorkflowUtils.replaceNodeId()   // 替换节点ID
//         └─ traverse()                        // 深度遍历JSON ↓
//             └─ visitor callback              // 处理每个节点

/** 
 * 
 * unique workflow utils - 唯一工作流工具 
 * 
*/
